...
public class DetailedChart_Microsoft {
    ...
    private final Number[] FULL_DEMO_DATA_SET = data.getMicrosoft().getData();
    ...
    protected Component getChart() {
        ...
        masterChart.addChartSelectionListener(new ChartSelectionListener() {
            ...
            public void onSelection(ChartSelectionEvent event) {
                ...
                List<Number> list = DetailedChart_Microsoft.this.getPartialList(
                        start, end);
    ...
    private Chart getDetailChart() {
        ...
        configuration.setTitle("Microsoft Stock");
        configuration
