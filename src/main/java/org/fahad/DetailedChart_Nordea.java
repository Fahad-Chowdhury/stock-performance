...
public class DetailedChart_Nordea {
    ...
    private final Number[] FULL_DEMO_DATA_SET = data.getNordea().getData();
    ...
    protected Component getChart() {
        ...
        masterChart.addChartSelectionListener(new ChartSelectionListener() {
            ...
            public void onSelection(ChartSelectionEvent event) {
                ...
                List<Number> list = DetailedChart_Nordea.this.getPartialList(
                        start, end);
    ...
    private Chart getDetailChart() {
        ...
        configuration.setTitle("Nordea Stock");
        configuration
