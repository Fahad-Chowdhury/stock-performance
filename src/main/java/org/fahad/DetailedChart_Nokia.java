...
public class DetailedChart_Nokia {
    ...
    private final Number[] FULL_DEMO_DATA_SET_NOKIA = data.getNokia().getData();
    ...
    protected Component getChart() {
        ...
        masterChart.addChartSelectionListener(new ChartSelectionListener() {
            ...
            public void onSelection(ChartSelectionEvent event) {
                ...
                List<Number> list = DetailedChart_Nokia.this.getPartialList(
                        start, end);
    ...
    private List<Number> getPartialList(long start, long end) {
        ...
        for (int i = 0; i < FULL_DEMO_DATA_SET_NOKIA.length; i++) {
            ...
            if (dataTimeStamp > start && dataTimeStamp < end) {
                list.add(FULL_DEMO_DATA_SET_NOKIA[i]);
            }
        }
        return list;
    }
    ...
    private Chart getDetailChart() {
        ...
        configuration.setTitle("Nokia Stock");
        configuration
        ...
        seriesList.setName("Nokia");
        seriesList.setData(FULL_DEMO_DATA_SET_NOKIA);
    ...
    private Chart getMasterChart() {
        ...
        ls.setName("Nokia");
        ls.setData(FULL_DEMO_DATA_SET_NOKIA);
